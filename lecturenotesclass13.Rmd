...
They typically won't represent the actual mean.
...
This means that we can say with 95 percent certainty that the mean value lies within 2300 and 2980.
...
We are 95 percent confident that the true proprtion of mice that died when not on the treatment is between .690 and .797
...
```{r practice_2_ci}
mice_treatment_surv <- get_ci(boot_prop2, level = .9)
mice_treatment_surv
```
